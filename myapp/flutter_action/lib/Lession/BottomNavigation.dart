    ...
    return new FadeTransition(
      ...
      child: new SlideTransition(
        position: new Tween<Offset>(
          begin: const Offset(0.0, 0.02), // 此变量在动画开头的值
...
class _BottomNavigation extends State<BottomNavigation> with TickerProviderStateMixin {
  ...
  BottomNavigationBarType _type = BottomNavigationBarType.shifting; // 存储底部导航栏的布局和行为：在点击时会变大
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      ...
      body: new Center(
        child: _buildTransitionsStack(),// 主要内容：_buildTransitionsStack函数的返回值
      ),
